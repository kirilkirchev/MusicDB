...
public class Datasource {
    ...
    public static final String CONNECTION_STRING = "jdbc:sqlite:D:\\Kiril\\Java\\Projects\\DBMusic" + DB_NAME;
    ...
    public boolean creteViewForSongArtist () {
        try (Statement statement = conn.createStatement()) {
        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    System.out.println("Could not rest auto = commit!" + e3.getMessage());
                }
            }
        }
    }
